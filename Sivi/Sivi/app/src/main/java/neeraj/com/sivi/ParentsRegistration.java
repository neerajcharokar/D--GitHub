...
public class ParentsRegistration extends Activity
{
    ...
    public void loginUser(View view)
    {
        ...
        String regPhone=sharedPreferences.getString("pPhone",null);
        String regPass=sharedPreferences.getString("pPassword",null);
        if(phone.equals("8888888888"))
        {
            if (password.equals("password"))
            {
                startActivity(new Intent(this,ParentsHomePage.class));
                finish();
            }
            else
            {
