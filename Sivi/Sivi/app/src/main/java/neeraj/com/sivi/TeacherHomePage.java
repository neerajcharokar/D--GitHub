...
public class TeacherHomePage extends AppCompatActivity
{
    ...
    protected void onCreate(Bundle savedInstanceState) {
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item)
            {
                switch (item.getItemId())
                {
                    case R.id.setting: {
                        ...
                        Toast.makeText(TeacherHomePage.this, "Group Selected", Toast.LENGTH_SHORT).show();
                    ...
                    case R.id.logout:
                    {
                        item.setChecked(true);
                        drawerLayout.closeDrawers();
                        startActivity(new Intent(TeacherHomePage.this,LoginHomeActivity.class));
                        finish();
                        return true;
                    }
                }
        ...
        myPageAdapter=new TeacherHomePage.MyPageAdapter(getSupportFragmentManager());
            ...
            public void onTabSelected(TabLayout.Tab tab)
            {
                switch (tab.getPosition())
                {
                    ...
                    case 1:
                        ...
                        break;
                    case 2:
                        getSupportFragmentManager().beginTransaction().add(R.id.homePageFragment,new TeacherHomework()).commit();
                        break;
                }
            }
